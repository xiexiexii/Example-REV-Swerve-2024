...
public class RobotContainer {
  ...
  // PATHPLANNING is likely replacing manual autos like these, so it's
  // not likely you need to look into this example auto too much if you're
  // learning and using pathplanner
  ...
  public Command getAutonomousCommand() {
    ...
    TrajectoryConfig config = new TrajectoryConfig(
        ...
        // Adds kinematics to ensure max speed is actually obeyed
